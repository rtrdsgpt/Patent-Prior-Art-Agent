...
def test_build_chroma_client_uses_persistent_client_when_host_unset(monkeypatch):
    ...
    monkeypatch.setattr("api.pipeline.chromadb.PersistentClient", mock_persistent_client)
